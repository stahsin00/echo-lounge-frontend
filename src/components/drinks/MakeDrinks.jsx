  ...
  const [mixed, setMixed] = useState(false);
      ...
      const handleServe = () => {
        const drinks = recipes.drinks.filter(drink => {
          return Object.keys(selectedIngredients).every(ingredient => 
            drink.ingredients[ingredient] === selectedIngredients[ingredient]
          );
        });

        const drink = (drinks.length == 1) ? 
          drinks[0] 
          : 
          {
            name: "Unknown Drink",
            description: "This unknown drink is not from the menu. Will this odd experiment turn out well?",
    ...
    <div className='make-drink'>
        <div className='ingredient-area'>
          <div className='ingredient-list'>
              ...
              <Ingredient name={"Plasma Peppers"} ingredient={"plasma-peppers"} handleAddIngredient={handleAddIngredient} handleRemoveIngredient={handleRemoveIngredient}/>
        ...
        <div className='mixing-area'>
            ...
            <div className='mixing-area-buttons'>
                ...
                <button onClick={handleServe} disabled={state == "Waiting" || customer == null} >Serve</button>
            </div>
        </div>
    </div>
  )
